    ...
    <div class="profile-and-content">
      ...
      <div class="profile-info">
        ...
        <div class="level" id="level">
          <h1>My Level</h1>
          <ul>
            <li><b>Skiing:</b> Beginner</li>
            <li><b>Snowboarding:</b> Beginner</li>
            <li><b>Sledding:</b> Beginner</li>
            <li><b>Ice Climbing:</b> Beginner</li>
          </ul>
        </div>
      </div>
      ...
      <div class="main-content-group">
        ...
        <div class="studentinfo" id="studentinfo">
          <h1>Student Info</h1>
          <ul>
            <li><p>Bdate</p><p>1/1/2001</p></li>
            <li><p>Weight</p><p>65 kg</p></li>
            <li><p>Height</p><p>170 cm</p></li>
            <li><p>Disabilities</p><p>None</p></li>
            <li><p>Emergency Contact</p><p>76767676</p></li>
          </ul>
        </div>
